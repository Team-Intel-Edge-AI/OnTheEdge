...
class LoadStreams:
    ...
    def __init__(self, f_in=None, img_size=640, stride=32, auto=True, transforms=None, vid_stride=1, fps=30, frame_cnt=0):
        ...
        self.frame = f_in
        self.fps = fps
        self.frames[0] = max(int(frame_cnt), 0) or float('inf')  # infinite stream fallback
        self.imgs[0] = f_in  # guarantee first frame
