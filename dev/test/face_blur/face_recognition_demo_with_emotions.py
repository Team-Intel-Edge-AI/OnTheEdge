...
class EmotionDetector:
    ...
    def __init__(self, model_path='./intel/emotions-recognition-retail-0003/FP16/emotions-recognition-retail-0003.xml'):
        self.core = Core()
...
# 231230 
def draw_detections(frame, frame_processor, detections, output_transform, blur_mode):
    size = frame.shape[:2]
...
def main():
    ...
    while True:
        ...
        blur_mode = "CHANGE"
        frame = draw_detections(frame, frame_processor, detections, output_transform, blur_mode)
        frame_num += 1
